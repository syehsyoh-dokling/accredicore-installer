...
if ! command -v node >/dev/null 2>&1; then
  show_notice \
    ...
    "Your device does not have Node.js installed. The native installer needs Node.js and npm to start the desktop launcher. If you continue, we will open the official Node.js download page. After installing Node.js LTS, run Launch-Gui.sh again."
